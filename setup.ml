...
(* OASIS_START *)
<<<<<<< HEAD
(* DO NOT EDIT (digest: 9d89e3f3b1c8828c2aed0b21eccf3e24) *)
||||||| merged common ancestors
(* DO NOT EDIT (digest: cc2ef85dde55f6841988f7967494ecff) *)
=======
(* DO NOT EDIT (digest: 234cd7426fc0ed3f2061ed9c75a8157a) *)
>>>>>>> clegg/master
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("capture", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("capture", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("cstruct",
                               Some (OASISVersion.VGreaterEqual "0.5.0"));
...
||||||| merged common ancestors
                      ...
                      lib_findlib_name = Some "pcap-format";
...
||||||| merged common ancestors
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "capture";
...
||||||| merged common ancestors
                   ...
                   {exec_custom = true; exec_main_is = "print.ml"; });
               Executable
                 ({
                     cs_name = "flows";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "flows.ml"; });
               Executable
                 ({
                     cs_name = "packed_flow";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "packed_flow.ml"; });
               Executable
                 ({
                     cs_name = "copy";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      bs_path = "unix";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "capture"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "copy.ml"; });
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
...
||||||| merged common ancestors
                   ...
                   {exec_custom = true; exec_main_is = "capture.ml"; })
=======
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {exec_custom = true; exec_main_is = "capture.ml"})
...
<<<<<<< HEAD
     oasis_version = "0.3.0";
     oasis_digest = Some "\135o\159Å\005K`yÒ\131êã¶\142?ö";
||||||| merged common ancestors
     oasis_version = "0.3.0";
     oasis_digest = Some "Ö\147©®ÒN\004Õ¦ Ç5Ê\020NJ";
=======
     oasis_version = "0.4.4";
     oasis_digest = Some "\174\140{R\164\172\191-\n\023\147\201=a\218(";
>>>>>>> clegg/master
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
