...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7bb5552340bcedbadbd347cf28f266b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "ocap";
                      lib_findlib_name = Some "ps";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ps"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
          ...
          plugins =
            [(`Extra, "META", Some "0.2"); (`Extra, "DevFiles", Some "0.2")];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "µ¡\135·\158\018Ô,Ó¹\1530\\\148¸;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
