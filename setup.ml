...
(* OASIS_START *)
(* DO NOT EDIT (digest: f46e7faa2484932a09a0c7e451a258a5) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build Unix targets";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build Mirage targets";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "pcap-format";
                           InternalLibrary "pcap-format.unix";
                   ...
                   {exec_custom = false; exec_main_is = "ocap_cmd.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "=`\011\137\128Е\r§\138т!\004ля\tС";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
